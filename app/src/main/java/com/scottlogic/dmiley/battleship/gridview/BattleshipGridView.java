...
public class BattleshipGridView extends View {
  ...
  protected void redrawCanvas(GridLocation northWestGridExtremity, GridLocation southEastGridExtremity) {
    int westGridBorder = northWestGridExtremity.getColumn() == 0 ?
      defaultBorderPixelSize : 2 * defaultBorderPixelSize;
    int northGridBorder = northWestGridExtremity.getRow() == 0 ?
      defaultBorderPixelSize : 2 * defaultBorderPixelSize;
    int eastGridBorder = northWestGridExtremity.getColumn() == 0 && southEastGridExtremity.getColumn() == 0 ?
      defaultBorderPixelSize : 2 * defaultBorderPixelSize;
    int southGridBorder = northWestGridExtremity.getRow() == 0 && southEastGridExtremity.getRow() == 0 ?
      defaultBorderPixelSize : 2 * defaultBorderPixelSize;
  ...
  protected void drawCellBackground(Canvas canvas, GridLocation gridLocation, Paint paint) {
    int columnGridBorder = gridLocation.getColumn() == 0 ? defaultBorderPixelSize : 2 * defaultBorderPixelSize;
    int rowGridBorder = gridLocation.getRow() == 0 ? defaultBorderPixelSize :2 * defaultBorderPixelSize;
